...
von der vorsitzenden Person des Studentischen Konvents in der ersten
...
Sämtliche Referatsleitungen des Studentischen Konvents legen dem
Studentischen Konvent in der ersten Sitzung des neuen Kalenderjahres einen
...
Sitzung des Studentischen Konvents anwesend sein und für Rückfragen zur
...
\SubClause{title=Beauftragte für die Gleichstellung aller Geschlechter}\label{beauftragte-fuer-die-gleichstellung-aller-geschlechter}

Der Studentische Konvent wählt in der konstituierenden Sitzung
\begin{itemize}
...
Auf Wunsch der Beauftragten für die Gleichstellung aller Geschlechter kann der Studentische Konvent zu jeder Zeit weitere Stellvertreter:innen wählen.
